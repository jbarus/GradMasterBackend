...
@Component
public class StudentExtractionPipeline {
    List<XLSXFilter> filters;

    @Autowired
    public StudentExtractionPipeline(List<XLSXFilter> filters) {
